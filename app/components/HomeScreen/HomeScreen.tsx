        ...
        <div className="flex sm:flex-row flex-col bg-zinc-900">
          <div className="basis-1/2 text-center sm:text-left relative">
            ...
            >
              ...
              <a href="https://www.facebook.com/WebPlanexPVTLTD/"  rel="noopener noreferrer">
                <svg
                ...
                <a href="https://x.com/webplanex"  rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  className="w-5 h-5"
                ...
                <a href="https://www.instagram.com/webplanex/"  rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="w-5 h-5"
                ...
                <a href="https://www.youtube.com/user/WebPlanexPVTLTD"  rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 576 512"
                  className="w-5 h-5"
                ...
                <a href="https://www.linkedin.com/company/webplanex/"  rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="w-5 h-5"
